...
model_return_percentage = ((btc_rfr_total_value[-1]) - investment) / investment
...
with mlflow.start_run(run_name=run_name) as run:
  ...
  # Enregistrement des paramètres prédefinies
...
joblib.dump(rfr, "models/btc_model")
